...
> 上表为主数据集 v1.1.0 的栈。同一张 RTX 5090 在 [2026-09-20 会话](https://quantenergy.tech/#rtx5090-2026-09)
> （bitsandbytes 0.50.2）上重测同一 3B 模型为 **−8%**。硬件未变，变的是软件栈；工具里的曲线仍按前者拟合。
...
| 场景 | 结论 |
|------|------|
| **≥7B on RTX 5090** | NF4 节能 ~11%（v1.1.0 栈）/ ~32%（2026-09 bitsandbytes 0.50.2），推荐量化 |
| **1.1B on RTX 5090** | 取决于软件栈：v1.1.0 栈 +26%（保持 FP16），0.50.2 栈 −0.4%/+1.5%（与 FP16 无法区分） |
